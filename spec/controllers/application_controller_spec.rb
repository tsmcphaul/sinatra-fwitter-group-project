...
describe ApplicationController do
  ...
  describe 'index action' do
    ...
    #     user1 = User.create(:username => "becky567", :email => "starz@aol.com", :password_digest => "kittens")
    #     tweet1 = Tweet.create(:content => "tweeting!", :user_id => user1.id)

    #     user2 = User.create(:username => "silverstallion", :email => "silver@aol.com", :password_digest => "horses")
